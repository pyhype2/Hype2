...
def stopct():
    ...
    try:
        stop_lxc(lxc_name)
        flash(lxc_name+' stopped', category='success')
    except Exception as e:
        flash('Error stopping '+lxc_name+':'+str(e), category='danger')
    return redirect(url_for('state'))
...
def stopvm():
    ...
    try:
        stop_vm(vm_name)
        flash(vm_name+' stopped', category='success')
    except Exception as e:
        flash('Error stopping '+vm_name+':'+str(e), category='danger')
    return redirect(url_for('state'))
